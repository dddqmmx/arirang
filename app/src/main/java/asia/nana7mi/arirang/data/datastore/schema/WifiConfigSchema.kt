...
data class WifiConfigSchema(
    ...
    @SerializedName("unchangedCurrentWifi") val unchangedCurrentWifi: Boolean = false,
    ...
    companion object {
        ...
        fun fromJson(json: String): WifiConfigSchema {
            ...
            return WifiConfigSchema(
                ...
                unchangedCurrentWifi = root.get("unchangedCurrentWifi")?.asBoolean ?: DEFAULTS.unchangedCurrentWifi,
    ...
    override fun toJson(): String {
        ...
        obj.addProperty("unchangedCurrentWifi", unchangedCurrentWifi)
