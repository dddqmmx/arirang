...
@Composable
internal fun DeviceInfoConfigScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                ConfigSectionCard(title = stringResource(R.string.device_section_identity)) {
            ...
            item {
                ConfigSectionCard(title = stringResource(R.string.device_section_build_target)) {
            ...
            item {
                ConfigSectionCard(title = stringResource(R.string.device_section_build_meta)) {
